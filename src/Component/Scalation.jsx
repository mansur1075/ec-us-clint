...
const Scalation = () => {
    return (
        <div role="status" className="w-[270px] p-4 rounded-sm animate-pulse md:p-6">
            <div className="flex items-center justify-center h-48 mb-4 bg-gray-300 rounded-sm dark:bg-gray-500">
            ...
            <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-500 mb-2.5" />
            <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-500" />
        </div>
    )
}

export default Scalation